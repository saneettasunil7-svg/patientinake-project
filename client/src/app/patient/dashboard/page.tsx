    ...
    */
    ...
    const refreshDoctors = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const depts = Array.from(new Set(docs.map((d: any) => d.specialization || 'General')));
                setDepartments(['All', ...depts as string[]]);
            }
        } catch {
    ...
    const checkBackendConnection = async () => {
        try {
            ...
            alert("Cannot connect to backend! Please accept the security certificate at " + getApiBaseUrl());
            router.push('/auth/login'); // Force re-login or just show error
        }
    };
